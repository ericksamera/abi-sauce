...
def read_ab1(name: str, raw: bytes, size: int, checksum: str) -> List[TraceAsset]:
    ...
    # These keys are common across many instruments; if missing, we leave None.
    ...
    # Qualities (PHRED) may be present as letter annotations or in abif_raw (PCON2)
    quals = None
